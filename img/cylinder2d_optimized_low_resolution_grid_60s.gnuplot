...
plot 'data/cylinder2d_optimized_low_resolution_grid_60s_3.csv' using ($6+0.05):($7+0.05):(sqrt($2*$2+$3*$3)) palette pt 5 ps 5.3 notitle,\
     'data/cylinder2d_optimized_low_resolution_grid_60s_2.csv' using 6:($7+0.05):(sqrt($2*$2+$3*$3)) palette pt 5 ps 2.6 notitle,\
     'data/cylinder2d_optimized_low_resolution_grid_60s_1.csv' using 6:($7+0.05):(sqrt($2*$2+$3*$3)) palette pt 5 ps 2.6 notitle,\
     'data/cylinder2d_optimized_low_resolution_grid_60s_0.csv' using 6:($7+0.05):(sqrt($2*$2+$3*$3)) palette pt 5 ps 1.6 notitle,\
